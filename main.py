...
if available_parts:
    if "selected_part_index" not in st.session_state or st.session_state.selected_part_index >= len(available_parts):
        st.session_state.selected_part_index = len(available_parts) - 1
        
    if st.session_state.processing and len(available_parts) - 1 > st.session_state.selected_part_index:
        st.session_state.selected_part_index = len(available_parts) - 1
    ...
    st.session_state.selected_part_index = available_parts.index(selected_part)
