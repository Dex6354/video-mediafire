...
# Pasta local para salvar o vídeo (st.video lê direto do HD com consumo zero de RAM)
LOCAL_DIR = "videos"
...
if os.path.exists(SAVE_PATH):
    st.markdown("---")
    st.subheader("🎬 Player Local (Suporta avanço e arquivos gigantes):")
    
    # O st.video passando o caminho do arquivo (string) gerencia as 
    # requisições parciais (Range Requests) perfeitamente de forma nativa.
    st.video(SAVE_PATH)
